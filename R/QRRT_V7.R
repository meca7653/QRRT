...
#' AIC \text{    } A version of Akaike's An Information Criterion\\
#' minus twice the maximized log-likelihood plus twice the number of parameters\\
#' Maximized_Log_Likelihood \text{    } log-likelihood with estimated coefficients\\
#' Number_Missing_Values \text{    } number of missing value in data set\\
#' Likelihood_by_Starting_Value \text{    } optimized likelihood value with different starting value\\
#' Score \text{    } score vector\\
#' Inverse_Fisher_Information \text{    } estimated covariance matrix\\
#'
#'
#' @examples
#' #-------------------------------------------------------------------------------------
